...
# 任务列表
TASKS=("square" "transport" "can" "lift" "tool_hang")
DATA_TYPES=("mh" "mh" "mh" "mh" "mh")  # 都使用mh (Multi-Human)
...
for i in "${!TASKS[@]}"; do
    ...
    # 运行训练
    echo "🏃 开始训练..."
    cd /home/yhj/桌面/ACT/adastep_extension  # 切换到AdaStep扩展目录
...
echo ""
echo "🎯 下一步:"
echo "  1. 检查训练日志: $RESULTS_DIR/results_*/train.log"
echo "  2. 查看模型文件: $RESULTS_DIR/results_*/models/"
echo "  3. 运行评估: python evaluate.py --results_dir $RESULTS_DIR"
echo ""
echo "🚀 AdaStep算法训练完成!"</content>
<parameter name="filePath">/home/yhj/桌面/ACT/adastep_extension/train_all_tasks_v2.sh